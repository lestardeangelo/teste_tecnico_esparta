...
const createProjectController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newProject = yield (0, createProject_service_1.createProjectService)({ name, description });
        return res.status(201).json((0, class_transformer_1.instanceToPlain)(newProject));
    }
    catch (error) {
        next(error);
    }
